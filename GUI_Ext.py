...
parser = ArgumentParser(description='Graphical User Interface Extension for SMCF')
...
if __name__ == '__main__':
    ...
    # Get all sub folders in the target input folder that has Result.csv in it
    target_folders = glob(INPUT_DIR + '/*/Result.csv')
    ...
    for each_target_folder in target_folders:
        ...
        if is_step_specified:
            print('python GUI.py -i "' + target_folder_name + '" -s ' + TARGET_STEPS)
            os.system('python GUI.py -i "' + target_folder_name + '" -s ' + TARGET_STEPS)
        else:
            print('python GUI.py -i "' + target_folder_name + '"')
            os.system('python GUI.py -i "' + target_folder_name + '"')